      ...
      <ul>
        {input.map((item, index) => (
          <li className="history-item">
            ...
            <span style={{ border: theme.border, color: theme.text }} onClick={() => onHistoryItemClicked(output[index])} className="history-element output-element">{output[index].substring(0, 10) + "..."}</span>
          </li>
        ))}
      </ul>
